...
const dict = {
  ...
  tools: {
    ...
    cardHolder: { pt: "Nome no cartão", en: "Name on card" },
    cardHolderPlaceholder: { pt: "NOME COMPLETO", en: "FULL NAME" },
    cardExpiry: { pt: "Validade", en: "Expiry" },
    cardExpiryPlaceholder: { pt: "MM/AA", en: "MM/YY" },
    cardCvv: { pt: "CVV", en: "CVV" },
    cardPreview: { pt: "Pré-visualização do cartão", en: "Card preview" },
    cardCopy: { pt: "Copiar {field}", en: "Copy {field}" },
    cardFlipHint: {
      pt: "Clique no cartão para virar. Copie pelo ícone — o CVV está no verso.",
      en: "Click the card to flip. Copy with the icon — CVV is on the back.",
    },
    cardFlipToBack: { pt: "Ver verso do cartão", en: "Show card back" },
    cardFlipToFront: { pt: "Ver frente do cartão", en: "Show card front" },
    cardDisclaimer: {
    ...
    cardValid: { pt: "Número válido — {brand}.", en: "Valid number — {brand}." },
    cardInvalid: { pt: "Número inválido.", en: "Invalid number." },
