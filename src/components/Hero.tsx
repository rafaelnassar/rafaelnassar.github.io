    ...
    >
      ...
      */}
      <motion.a
        ...
        className={cn(
          'absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-foreground/70 hover:text-foreground transition-colors duration-200 group cursor-pointer rounded-md',
          focusRing
        )}
      ...
      >
        ...
        >
          <motion.span
            animate={reduceMotion || !isHeroInView ? { y: 0 } : { y: [0, 8, 0] }}
            transition={{
              duration: 1.5,
              repeat: reduceMotion || !isHeroInView ? 0 : Infinity,
              ease: 'easeInOut',
            }}
